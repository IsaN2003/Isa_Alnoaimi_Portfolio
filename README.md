...
### Designing an Optimal Preventive Maintenance Plan for Pump Systems in a Urea Production Plant Using NSGA-II (Python and Excel)
...
Weibull Distribution Implementation on Excel
NSGA-II Implementation on Python
